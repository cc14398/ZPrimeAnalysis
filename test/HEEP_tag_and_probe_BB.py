...
if __name__ == "__main__":
    ...
    ROOT.etaAllPairsHist = ROOT.TH1D("EtaAllPairsHist",";eta;#entries;",25,-1.5,1.5)
    ROOT.etaIDSelPairsHist = ROOT.TH1D("EtaIDSelPairsHist",";eta;#entries;",25,-1.5,1.5)
    ROOT.etaAllProbesHist = ROOT.TH1D("EtaAllProbesHist",";eta;#entries;",25,-1.5,1.5)
    ROOT.etaPassingProbesHist = ROOT.TH1D("EtaPassingProbesHist",";eta;#entries;",25,-1.5,1.5)
